...
import { CARS, type Car, type Badge } from "@/constants/car";
    ...
    return (
        <Container maxWidth="lg" className="py-12">
            <Box className="flex flex-col gap-2">
                <Typography className="text-2xl font-bold text-slate-900">ชำระเงิน</Typography>
                    ...
                    <CardContent className="p-6">
                        ...
                        <Box className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4">
                            <Box className="flex items-center justify-between">
                                ...
                                <Typography className="text-sm font-semibold text-slate-900">{bookingId}</Typography>
                            </Box>
                            ...
                            {pickupDate || returnDate ? (
                                <Box className="mt-3 text-sm text-slate-600">
                                    <div>
                                        รับรถ:{" "}
                                        <span className="font-semibold text-slate-900">{pickupDate || "-"}</span>
                                    </div>
                                    <div>
                                        คืนรถ:{" "}
                        ...
                        {car ? (
                            <Box className="rounded-xl border border-slate-200 bg-white p-4">
                                ...
                                <Box className="mt-2 flex items-center gap-2">
                                    ...
                                    <Typography className="text-xs text-slate-500">{car.grade}/4</Typography>
                                </Box>
                    ...
                    <CardContent className="p-6">
                        ...
                        <Box className="mt-4 grid gap-4 sm:grid-cols-2">
                            ...
                            <Box className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                                <Typography className="text-xs text-slate-600">สถานะ</Typography>
                        ...
                        <Box className="mt-5 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                                ...
                                <Box className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                    <Box>
                                        ...
                                        <Typography className="mt-1 text-xs text-slate-500">
                                            * QR ตัวอย่าง — ต่อจริงให้ generate จาก backend/ผู้ให้บริการ
                                        </Typography>
                                    </Box>
                            ...
                            {method === "card" ? (
                                <Box className="grid gap-4 sm:grid-cols-2">
                                    <TextField label="หมายเลขบัตร" placeholder="1234 5678 9012 3456" fullWidth />
                                    <TextField label="ชื่อบนบัตร" placeholder="NAME SURNAME" fullWidth />
                                    <TextField label="หมดอายุ (MM/YY)" placeholder="12/30" fullWidth />
                                ...
                                <Box className="grid gap-4">
                                    ...
                                    {slipFile ? (
                                        <Typography className="text-xs text-slate-600">
                                            ไฟล์:{" "}
                                            <span className="font-semibold text-slate-900">{slipFile.name}</span>
                                        </Typography>
                                    ) : (
                                        <Typography className="text-xs text-slate-500">
