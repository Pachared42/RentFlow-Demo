...
import { CARS, type Car } from "@/constants/car";
...
export default function BookingPage() {
    ...
    const [pickupPoint, setPickupPoint] = React.useState<LocationPoint>(PICKUP_POINTS[0]);
    const [returnPoint, setReturnPoint] = React.useState<LocationPoint>(PICKUP_POINTS[0]);
    ...
    return (
        <Container maxWidth="lg" className="py-12">
            <Box className="flex flex-col gap-2">
                <Typography variant="h5" className="text-2xl font-bold text-slate-900">จองรถ</Typography>
            ...
            <Box className="mt-6 grid gap-6 lg:grid-cols-12">
                ...
                >
                    <CardContent className="p-4!">
                        <Typography className="text-sm font-semibold text-slate-900">สรุปการจอง</Typography>
                            ...
                            <Box className="rounded-xl! border border-slate-200 bg-white p-4!">
                                ...
                                <Box className="mt-3 flex items-start justify-between gap-3">
                                    <Box className="min-w-0">
                                        <Typography className="truncate text-base font-semibold text-slate-900">{car.name}</Typography>
                                ...
                                <Box className="mb-6! space-y-2 text-sm">
                                    ...
                                    <Box className="flex items-center justify-between">
                                        ...
                                        <Typography className="font-semibold text-slate-900">{days > 0 ? `${days} วัน` : "-"}</Typography>
                                    </Box>
                ...
                >
                    <CardContent className="p-6">
                        <Typography className="text-sm font-semibold text-slate-900">ข้อมูลการจอง</Typography>
                        <Typography className="mt-1 text-xs text-slate-500">
                        ...
                        <Box component="form" onSubmit={onSubmit} className="grid gap-4">
                            ...
                            <Box className="grid gap-4 sm:grid-cols-2">
                                <TextField
                                    ...
                                    label="จุดรับรถ"
                                    value={pickupPoint}
                                    onChange={(e) => setPickupPoint(e.target.value as LocationPoint)}
                                    fullWidth
                                    size="small"
                                    sx={fieldSX}
                                >
                                ...
                                <TextField
                                    ...
                                    label="จุดคืนรถ"
                                    value={returnPoint}
                                    onChange={(e) => setReturnPoint(e.target.value as LocationPoint)}
                                    fullWidth
                                    size="small"
                                    sx={fieldSX}
                                >
                            ...
                            {!car ? <Alert severity="info">ยังไม่ได้เลือกรถ — ไปที่หน้า “รถทั้งหมด” เพื่อเลือกคันที่ต้องการ</Alert> : null}
                        </Box>
                    </CardContent>
                </Card>
            </Box>
