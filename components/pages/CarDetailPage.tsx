...
import { type Car, type Badge } from "@/constants/car";
import { getCarDetail } from "@/constants/carDetails";
                    ...
                    <CardContent className="p-4!">
                        ...
                        <Box className="mt-5 grid gap-2">
                            <Button
                                ...
                                onClick={() => router.push(`/booking?carId=${encodeURIComponent(detail.id)}`)}
                            >
                                จองคันนี้
                            </Button>
            ...
            <Box className="mt-8 grid gap-6 lg:grid-cols-12">
                ...
                <Box className="lg:col-span-8 space-y-6">
                    <Box className="rounded-2xl border border-slate-200 bg-white p-4!">
                        <Typography className="text-sm font-semibold text-slate-900">รายละเอียดรถ</Typography>
                        <Typography className="mt-2 text-sm leading-relaxed text-slate-600">
                            รถรุ่น <span className="font-semibold text-slate-900">{detail.name}</span>{" "}
                            เหมาะสำหรับการใช้งานประเภท <span className="font-semibold text-slate-900">{detail.type}</span>{" "}
                            รองรับ <span className="font-semibold text-slate-900">{detail.seats} ที่นั่ง</span>{" "}
                            พร้อมระบบ <span className="font-semibold text-slate-900">{detail.transmission}</span>{" "}
                            และเชื้อเพลิง <span className="font-semibold text-slate-900">{detail.fuel}</span>.
                        </Typography>
                    </Box>

                    <Box className="rounded-2xl border border-slate-200 bg-white p-4!">
                        <Typography className="text-sm font-semibold text-slate-900">สิ่งที่รวมในราคา</Typography>

                        <Box className="mt-3 grid gap-3 sm:grid-cols-2">
                            <Box className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                <Box className="flex items-start gap-2">
                                    <TaskAltRoundedIcon fontSize="small" className="mt-0.5 text-emerald-600" />
                                    <Box>
                                        <Typography className="text-sm font-semibold text-slate-900" component="div">
                            ...
                            <Box className="rounded-2xl border border-slate-200 bg-white p-4">
                                <Box className="flex items-start gap-2">
                                    <DoNotDisturbAltRoundedIcon fontSize="small" className="mt-0.5 text-rose-600" />
                                    <Box>
                                        <Typography className="text-sm font-semibold text-slate-900" component="div">
                                            ค่าน้ำมัน
                                        </Typography>
                    ...
                    <Box className="rounded-2xl border border-slate-200 bg-white p-4!">
                        <Typography className="text-sm font-semibold text-slate-900">เงื่อนไขการเช่า</Typography>
                        <Box component="ul" className="mt-3 space-y-2 pl-5 text-sm text-slate-600">
                            ...
                            <Box component="li">การมัดจำ/ประกันและค่าธรรมเนียมขึ้นกับผู้ให้บริการ (ปรับได้)</Box>
                            <Box component="li">แนะนำถ่ายรูปสภาพรถก่อนออกเดินทางเพื่อความชัดเจน</Box>
                        </Box>
                    </Box>
                </Box>
                ...
                <Box className="lg:col-span-4 space-y-6">
                    <Box className="rounded-2xl border border-slate-200! bg-slate-50! p-4!">
                        <Typography className="text-sm font-semibold text-slate-900">สรุปสเปค</Typography>

                        <Box className="mt-3 grid gap-2 text-sm text-slate-700">
                            <Box className="flex items-center justify-between">
                                <Typography className="text-slate-600">ประเภท</Typography>
                                <Typography className="font-semibold text-slate-900">{detail.type}</Typography>
                            </Box>
                            <Box className="flex items-center justify-between">
                                <Typography className="text-slate-600">ที่นั่ง</Typography>
                                <Typography className="font-semibold text-slate-900">{detail.seats}</Typography>
                            </Box>
                            <Box className="flex items-center justify-between">
                                <Typography className="text-slate-600">เกียร์</Typography>
                                <Typography className="font-semibold text-slate-900">{detail.transmission}</Typography>
                            </Box>
                            <Box className="flex items-center justify-between">
                                <Typography className="text-slate-600">เชื้อเพลิง</Typography>
                                <Typography className="font-semibold text-slate-900">{detail.fuel}</Typography>
                            </Box>
                        </Box>
                    </Box>
                </Box>
