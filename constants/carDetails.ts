...
export const CAR_DETAILS: Record<string, CarDetail> = {
    c1: {
        ...
        features: ["Apple CarPlay/Android Auto", "กล้องถอยหลัง", "Cruise Control", "ระบบช่วยจอด", "Bluetooth/USB", "ถุงลมนิรภัย"],
        images: ["/cosySec.webp", "/cosySec1.webp", "/cosySec2.webp"],
        pickupLocations: ["กรุงเทพฯ (ดอนเมือง)", "กรุงเทพฯ (สุวรรณภูมิ)", "สุพรรณบุรี (ตัวเมือง)"],
        policy: {
            deposit: 5000,
            ...
            insurance: ["ประกันชั้น 1", "คุ้มครองอุบัติเหตุ", "บริการช่วยเหลือฉุกเฉิน 24/7"],
        },
        specs: {
            year: 2022,
    ...
    c2: {
        ...
        features: ["ระบบ Hybrid/EV Mode", "Apple CarPlay", "กล้องถอย", "Lane Assist", "Adaptive Cruise", "Keyless Start"],
    ...
    c3: {
        ...
        features: ["Sport Mode", "เบาะสปอร์ต", "Apple CarPlay", "กล้อง 360", "Brembo (สไตล์)", "ระบบเตือนมุมอับ"],
        ...
        policy: {
            ...
            idDocs: ["บัตรประชาชน/พาสปอร์ต", "ใบขับขี่"],
            insurance: ["ประกันชั้น 1", "ความรับผิดต่อบุคคลภายนอก", "ช่วยเหลือฉุกเฉิน 24/7"],
        },
        specs: {
            year: 2021,
    ...
    c4: {
        ...
        features: ["ชาร์จเร็ว (ตามสถานี)", "จอใหญ่", "กล้องรอบคัน", "Lane Assist", "Adaptive Cruise", "Keyless"],
        ...
        policy: {
            ...
            licenseRequiredYears: 1,
            idDocs: ["บัตรประชาชน/พาสปอร์ต", "ใบขับขี่"],
            insurance: ["ประกันชั้น 1", "คุ้มครองแบตเตอรี่ (เงื่อนไข)", "ช่วยเหลือฉุกเฉิน 24/7"],
        },
        specs: {
            year: 2024,
            power: "340 hp",
    ...
    c5: {
        ...
        features: ["กล้อง 360", "จอผู้โดยสาร", "ระบบช่วยจอด", "Adaptive Cruise", "ไฟ Ambient", "เครื่องเสียงพรีเมียม"],
    ...
    c6: {
        ...
        features: ["เบาะหลังปรับไฟฟ้า", "ม่านบังแดด", "กล้อง 360", "ระบบช่วยจอด", "เครื่องเสียงพรีเมียม", "ไฟ Ambient"],
